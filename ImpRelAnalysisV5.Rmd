...
This script loads the version that was run in June of 2018. It is marked V5. It is the same as V4, but uses a different seed: `49204`.
...
```{r}
flLst <- list.files("./Sim5Results/", full.names = T)
